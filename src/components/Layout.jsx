    ...
    <div style={{ display:'flex', height:'100vh', overflow:'hidden' }}>
      <aside style={{
        ...
        <div style={{ padding:'0 20px 28px' }}>
          <div style={{ fontSize:11, color:'var(--text3)', letterSpacing:'0.1em', textTransform:'uppercase', marginBottom:4 }}>
            Scanplore.ia
          </div>
          <div style={{ fontSize:22, fontWeight:600, color:'var(--accent)', letterSpacing:'-0.02em' }}>
            Bussola
          </div>
        </div>
        ...
        <div style={{ padding:'16px 20px', borderTop:'1px solid var(--border)' }}>
          ...
          <button onClick={sair} disabled={saindo}
            style={{ fontSize:12, color:'var(--text3)', background:'none', padding:0, marginTop:6, cursor:'pointer', border:'none' }}>
            {saindo ? 'Saindo...' : 'Sair'}
          </button>
        </div>
      </aside>
